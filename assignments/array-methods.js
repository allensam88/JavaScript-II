...
// let firstNamesAllCaps = runners.map(drunkPower);
// function drunkPower(item){
...
// // Problem 1
// const ticketOverFifty = runners.filter(function(item){
//   return item.donation > 50;
// })
// console.log(ticketOverFifty);
